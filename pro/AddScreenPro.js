...
import ActiveAppsPro from './activeAppsPro';
import NoActiveAppsPro from './noActiveAppsPro';


export default function AddScreenPro({navigation}) {
  ...
  const renderPage = () => {
    if (currentPage === 'Page1') {
      return <ActiveAppsPro/>;
    } else if (currentPage === 'Page2') {
      return  <NoActiveAppsPro/>;
    }
  };
